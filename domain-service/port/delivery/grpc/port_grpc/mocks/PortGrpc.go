...
// Package mock_port_grpc is a generated GoMock package.
package mock_port_grpc

import (
	context "context"
	gomock "github.com/golang/mock/gomock"
	port_grpc "github.com/port-project/domain-service/port/delivery/grpc/port_grpc"
...
func (m *MockPortHandlerClient) GetPort(ctx context.Context, in *port_grpc.SingleRequest, opts ...grpc.CallOption) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
...
func (m *MockPortHandlerClient) GetAll(ctx context.Context, in *port_grpc.EmptyRequest, opts ...grpc.CallOption) (*port_grpc.ListPort, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*port_grpc.ListPort)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPortHandlerClient) Store(ctx context.Context, in *port_grpc.Port, opts ...grpc.CallOption) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockPortHandlerClient) Update(ctx context.Context, in *port_grpc.Port, opts ...grpc.CallOption) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockPortHandlerClient) Delete(ctx context.Context, in *port_grpc.SingleRequest, opts ...grpc.CallOption) (*port_grpc.DeleteResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*port_grpc.DeleteResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetPort mocks base method
func (m *MockPortHandlerServer) GetPort(arg0 context.Context, arg1 *port_grpc.SingleRequest) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method
func (m *MockPortHandlerServer) GetAll(arg0 context.Context, arg1 *port_grpc.EmptyRequest) (*port_grpc.ListPort, error) {
	m.ctrl.T.Helper()
...
// Store mocks base method
func (m *MockPortHandlerServer) Store(arg0 context.Context, arg1 *port_grpc.Port) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method
func (m *MockPortHandlerServer) Update(arg0 context.Context, arg1 *port_grpc.Port) (*port_grpc.Port, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method
func (m *MockPortHandlerServer) Delete(arg0 context.Context, arg1 *port_grpc.SingleRequest) (*port_grpc.DeleteResponse, error) {
	m.ctrl.T.Helper()
